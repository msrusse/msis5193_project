...
movies_awards <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\academy_award_winning_movies.csv', header = TRUE)
movies_data <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\box_office_movies.csv', header = TRUE)
...
movies_data$nominations[is.na(movies_data$nominations)] <- 0
...
movie_actors <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\all_movie_actors.csv', header = TRUE)
movie_genres <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\all_movie_genres.csv', header = TRUE)
movie_companies <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\all_movie_production_companies.csv', header = TRUE)
movie_ratings <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\all_movie_ratings.csv', header = TRUE)
movie_content_ratings <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\all_movie_content_ratings.csv', header = TRUE)
movie_directors <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\all_movie_directors.csv', header = TRUE)
...
oscar_actors <- read.csv(file = 'C:\\Users\\Rrsha\\OneDrive\\Documents\\oscar_actors.csv', header = TRUE)
...
for (i in 1:nrow(movies_data)){
  ...
  movies_data[i,44] = count
}


#Export dataframe
write.csv(movies_data,'C:\\Users\\Rrsha\\OneDrive\\Documents\\msis5193_project\\movies_data_combined.csv', row.names = FALSE)
